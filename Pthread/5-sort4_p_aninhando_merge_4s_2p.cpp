...
void *MergeSort(void *param){
    struct dataPMS *parametersMS = (struct dataPMS *)param;
...
void *MS(void *param){
    ...
    pthread_create(&threads[0], NULL, MergeSort, (void *)&partA);
    ...
    pthread_create(&threads[1], NULL, MergeSort, (void *)&partB);
    ...
    parametersPM.p1 = parametersPMS->p;
    parametersPM.r1 = parametersPMS->s + qL - 1;
    parametersPM.p2 = parametersPMS->s + qL;
    parametersPM.r2 = parametersPMS->r;
    parametersPM.A = parametersPMS->B;
    parametersPM.p3 = parametersPMS->s;
...
int main()
{
    ...
    parametersPM.p2 = qL + 1;
    parametersPM.r2 = n;
    parametersPM.A = parametersPMS.A;
    parametersPM.p3 = parametersPMS.s;
    PM(&parametersPM);
